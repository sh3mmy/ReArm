  ...
  const features = [
    {
      ...
      description: 'ReArm adapts instantly with AI-driven grip adjustments, learning your patterns in real time.',
      stat: '2.4 TOPS',
      statLabel: 'Neural performance',
      delay: 0
    },
    {
      icon: Zap,
      title: 'Adaptive Grip Pressure',
      description: 'Sensitive and strong for any task — from the most delicate to the most demanding.',
      stat: '<15ms',
    ...
    },
    {
      ...
      description: 'Customize interaction modes with swappable magnetic modules for unparalleled functionality.',
      stat: '6 Modes',
      statLabel: 'Interchangeable',
      delay: 200
    },
    {
      icon: Clock,
      title: 'Ultra-Fast Response',
      description: 'ReArm reacts faster than the human body\'s natural reflexes, ensuring seamless control.',
      stat: '0.3s',
      statLabel: 'Activation speed',
      delay: 300
    },
    {
      icon: Shield,
      title: 'Built to Last',
      description: 'Aerospace-grade titanium and carbon fiber construction resists wear for decades.',
      stat: '25+ Years',
      statLabel: 'Expected lifespan',
      delay: 400
    }
  ];
              ...
              <div className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center ${index % 2 === 1 ? 'lg:grid-flow-dense' : ''}`}>
                ...
                <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                  <div className="card-premium aspect-[4/3] flex items-center justify-center relative overflow-hidden group">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                      <div className="w-20 h-20 rounded-2xl bg-white/[0.04] border border-white/[0.06] flex items-center justify-center mb-6 group-hover:scale-105 transition-transform duration-500 ease-premium">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-label text-neutral-500 mt-1">{statLabel}</div>
                      </div>
                    </div>
                ...
                <div className={index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}>
                  <div className="flex items-center gap-4 mb-6">
                    <span className="text-label text-accent-400/70">{String(index + 1).padStart(2, '0')}</span>
                    <div className="flex-1 h-px bg-gradient-to-r from-white/10 to-transparent" />
                  </div>
                  <h3 className="heading-section text-2xl lg:text-3xl text-white mb-4">{title}</h3>
                  <p className="body-premium text-neutral-400 leading-relaxed text-lg">{description}</p>
                </div>
              </div>
            </div>
          ))}
