    ...
    <section className="relative py-32 lg:py-40 bg-neutral-950 overflow-hidden" ref={ref}>
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
        <div className={`transition-all duration-1000 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="font-light text-white mb-8 tracking-[-0.03em] leading-[0.95]" style={{ fontSize: 'clamp(2.5rem, 5vw, 4.5rem)' }}>
            Built Around You.
          </h2>
          <p className="font-light text-lg lg:text-xl text-neutral-400 max-w-2xl mx-auto mb-12 leading-relaxed">
            Experience the future of prosthetics. Request a private demo and begin your ReArm journey.
          </p>
          <Link to="/private-demo" className="btn-premium group inline-flex">
